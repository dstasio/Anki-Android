...
import com.ichi2.lowanki.FlashCardsContract;
import com.ichi2.lowanki.FlashCardsContract.Card;
import com.ichi2.lowanki.FlashCardsContract.CardTemplate;
import com.ichi2.lowanki.FlashCardsContract.Deck;
import com.ichi2.lowanki.FlashCardsContract.Model;
import com.ichi2.lowanki.FlashCardsContract.Note;
import com.ichi2.lowanki.FlashCardsContract.AnkiMedia;
...
public final class AddContentApi {
    ...
    private static final String PROVIDER_SPEC_META_DATA_KEY = "com.ichi2.lowanki.provider.spec";
     ...
     * <pre>
     *     <code>
     *     getContext().grantUriPermission("com.ichi2.lowanki", uri, Intent.FLAG_GRANT_READ_URI_PERMISSION)
