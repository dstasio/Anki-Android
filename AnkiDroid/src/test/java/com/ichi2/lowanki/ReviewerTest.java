...
import com.ichi2.lowanki.AbstractFlashcardViewer.JavaScriptFunction;
import com.ichi2.lowanki.cardviewer.ViewerCommand;
import com.ichi2.lowanki.reviewer.ActionButtonStatus;
...
import static com.ichi2.lowanki.AbstractFlashcardViewer.EASE_4;
import static com.ichi2.lowanki.AbstractFlashcardViewer.RESULT_DEFAULT;
...
public class ReviewerTest extends RobolectricTest {
    ...
    private void disableAllReviewerAppBarButtons() {
        ...
        SharedPreferences preferences = LowkeyAnkiDroidApp.getSharedPrefs(getTargetContext());
    ...
    public void baseDeckName() {
        ...
        Model basic = models.byName(LowkeyAnkiDroidApp.getAppResources().getString(R.string.basic_model_name));
        basic.put("did", didAb);
