...
import com.ichi2.lowanki.contextmenu.AnkiCardContextMenu;
import com.ichi2.lowanki.contextmenu.CardBrowserContextMenu;
import com.ichi2.lowanki.debug.DatabaseLock;
import com.ichi2.lowanki.exception.ConfirmModSchemaException;
import com.ichi2.lowanki.exception.StorageAccessException;
import com.ichi2.lowanki.services.BootService;
...
public class Preferences extends AppCompatPreferenceActivity implements PreferenceContext, OnSharedPreferenceChangeListener {
    ...
    public static Intent getPreferenceSubscreenIntent(Context context, String subscreen) {
        ...
        i.putExtra(android.preference.PreferenceActivity.EXTRA_SHOW_FRAGMENT, "com.ichi2.lowanki.Preferences$SettingsFragment");
    ...
    private void initSubscreen(String action, PreferenceContext listener) {
        ...
        switch (action) {
            case "com.ichi2.lowanki.prefs.general":
                ...
                break;
            case "com.ichi2.lowanki.prefs.reviewing":
                ...
                fullscreenPreference.setOnPreferenceChangeListener((preference, newValue) -> {
                    SharedPreferences prefs = LowkeyAnkiDroidApp.getSharedPrefs(Preferences.this);
                ...
                customButtonsPreference.setOnPreferenceClickListener(preference -> {
                    Intent i = getPreferenceSubscreenIntent(Preferences.this,
                            "com.ichi2.lowanki.prefs.custom_buttons");
                    startActivity(i);
                    return true;
                });
                break;
            case "com.ichi2.lowanki.prefs.appearance":
            ...
            case "com.ichi2.lowanki.prefs.custom_buttons":
                ...
                reset_custom_buttons.setOnPreferenceClickListener(preference -> {
                    SharedPreferences.Editor edit = LowkeyAnkiDroidApp.getSharedPrefs(getBaseContext()).edit();
                ...
                break;
            case "com.ichi2.lowanki.prefs.advanced":
                ...
                customSyncServerPreference.setOnPreferenceClickListener(preference -> {
                    Intent i = getPreferenceSubscreenIntent(Preferences.this,
                            "com.ichi2.lowanki.prefs.custom_sync_server");
                    startActivity(i);
                    return true;
                });
                ...
                advancedStatisticsPreference.setOnPreferenceClickListener(preference -> {
                    Intent i = getPreferenceSubscreenIntent(Preferences.this,
                            "com.ichi2.lowanki.prefs.advanced_statistics");
                    startActivity(i);
                    return true;
                });
            ...
            case "com.ichi2.lowanki.prefs.custom_sync_server":
                ...
                break;
            case "com.ichi2.lowanki.prefs.advanced_statistics":
    ...
    private void updatePreference(SharedPreferences prefs, String key, PreferenceContext listener) {
        try {
            ...
            switch (key) {
                ...
                case LowkeyAnkiDroidApp.FEEDBACK_REPORT_KEY: {
                    String value = prefs.getString(LowkeyAnkiDroidApp.FEEDBACK_REPORT_KEY, "");
                    LowkeyAnkiDroidApp.getInstance().setAcraReportingMode(value);
                    // If the user changed error reporting, make sure future reports have a chance to post
                    LowkeyAnkiDroidApp.deleteACRALimiterData(this);
                ...
                case "providerEnabled": {
                    ComponentName providerName = new ComponentName(this, "com.ichi2.lowanki.provider.CardContentProvider");
    ...
    private void updateGestureCornerTouch(android.preference.PreferenceScreen screen) {
        boolean gestureCornerTouch = LowkeyAnkiDroidApp.getSharedPrefs(this).getBoolean("gestureCornerTouch", false);
    ...
    private void updateSummary(android.preference.Preference pref) {
        ...
        switch (pref.getKey()) {
            ...
            case "custom_sync_server_link":
                SharedPreferences preferences = LowkeyAnkiDroidApp.getSharedPrefs(this);
            ...
            case "advanced_statistics_link":
                if (!LowkeyAnkiDroidApp.getSharedPrefs(this).getBoolean("advanced_statistics_enabled", false)) {
                    pref.setSummary(R.string.disabled);
                } else {
    ...
    public static class SettingsFragment extends android.preference.PreferenceFragment implements PreferenceContext, OnSharedPreferenceChangeListener {
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            UsageAnalytics.sendAnalyticsScreenView(subscreen.replaceFirst("^com.ichi2.lowanki.", ""));
