...
public class Whiteboard extends View {
    ...
    public Whiteboard(AbstractFlashcardViewer cardViewer, boolean inverted, boolean monochrome) {
        ...
        int wbStrokeWidth = LowkeyAnkiDroidApp.getSharedPrefs(cardViewer).getInt("whiteBoardStrokeWidth", 6);
    ...
    private static Point getDisplayDimenions() {
        Display display = ((WindowManager) LowkeyAnkiDroidApp.getInstance().getApplicationContext().
