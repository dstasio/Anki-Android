package com.ichi2.lowanki.services;
...
import static com.ichi2.lowanki.DeckOptions.reminderToCalendar;

public class BootService extends BroadcastReceiver {

    /**
     * This service is also run when the app is started (from {@link LowkeyAnkiDroidApp},
    ...
    public static void scheduleNotification(Time time, Context context) {
        AlarmManager alarmManager = (AlarmManager) context.getSystemService(Context.ALARM_SERVICE);
        SharedPreferences sp = LowkeyAnkiDroidApp.getSharedPrefs(context);
