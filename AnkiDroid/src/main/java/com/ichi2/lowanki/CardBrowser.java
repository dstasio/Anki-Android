...
import com.ichi2.lowanki.dialogs.CardBrowserMySearchesDialog;
import com.ichi2.lowanki.dialogs.CardBrowserOrderDialog;
import com.ichi2.lowanki.dialogs.ConfirmationDialog;
import com.ichi2.lowanki.dialogs.IntegerDialog;
import com.ichi2.lowanki.dialogs.RescheduleDialog;
import com.ichi2.lowanki.dialogs.SimpleMessageDialog;
import com.ichi2.lowanki.dialogs.TagsDialog;
import com.ichi2.lowanki.receiver.SdCardReceiver;
import com.ichi2.lowanki.widgets.DeckDropDownAdapter;
...
import static com.ichi2.lowanki.CardBrowser.Column.*;
...
public class CardBrowser extends NavigationDrawerActivity implements
    ...
    * When the list is changed, the position member of its elements should get changed.*/
    ...
    protected void changeCardOrder(int which) {
        if (which != mOrder) {
            ...
            if (mOrder == 0) {
                ...
                LowkeyAnkiDroidApp.getSharedPrefs(getBaseContext()).edit()
    ...
    protected void onCollectionLoaded(Collection col) {
        ...
        mColumn1Index = LowkeyAnkiDroidApp.getSharedPrefs(getBaseContext()).getInt("cardBrowserColumn1", 0);
        cardsColumn1Spinner.setOnItemSelectedListener(new OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int pos, long id) {
                ...
                if (pos != mColumn1Index) {
                    mColumn1Index = pos;
                    LowkeyAnkiDroidApp.getSharedPrefs(LowkeyAnkiDroidApp.getInstance().getBaseContext()).edit()
        ...
        mColumn2Index = LowkeyAnkiDroidApp.getSharedPrefs(getBaseContext()).getInt("cardBrowserColumn2", 0);
    ...
    private static String formatQA(String text, Context context) {
        boolean showFilenames = LowkeyAnkiDroidApp.getSharedPrefs(context).getBoolean("card_browser_show_media_filenames", false);
    ...
    public static class CardCache extends Card.Cache implements PositionAware {
        ...
        public String getColumnHeaderText(Column key) {
            ...
            case EASE:
                if (getCard().getType() == Consts.CARD_TYPE_NEW) {
                    return LowkeyAnkiDroidApp.getInstance().getString(R.string.card_browser_interval_new_card);
                } else {
            ...
            case INTERVAL:
                ...
                case Consts.CARD_TYPE_LRN :
                    return LowkeyAnkiDroidApp.getInstance().getString(R.string.card_browser_interval_learning_card);
                default:
                    return Utils.roundedTimeSpanUnformatted(LowkeyAnkiDroidApp.getInstance(), getCard().getIvl()*SECONDS_PER_DAY);
                }
            case LAPSES:
        ...
        */
        public void updateSearchItemQA() {
            ...
            a = formatQA(a, LowkeyAnkiDroidApp.getInstance());
            q = formatQA(q, LowkeyAnkiDroidApp.getInstance());
            mQa = new Pair<>(q, a);
        }
