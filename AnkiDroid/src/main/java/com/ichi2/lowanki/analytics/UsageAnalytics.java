...
public class UsageAnalytics {
    ...
    synchronized public static GoogleAnalytics initialize(Context context) {
        ...
        SharedPreferences userPrefs = LowkeyAnkiDroidApp.getSharedPrefs(context);
    ...
    synchronized public static void reInitialize() {
        ...
        initialize(LowkeyAnkiDroidApp.getInstance().getApplicationContext());
    }
    ...
    public static boolean isEnabled() {
        SharedPreferences userPrefs = LowkeyAnkiDroidApp.getSharedPrefs(LowkeyAnkiDroidApp.getInstance());
