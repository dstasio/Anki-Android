...
import com.ichi2.lowanki.reviewer.PeripheralKeymap;
import com.ichi2.lowanki.reviewer.ReviewerUi;
import com.ichi2.lowanki.workarounds.FirefoxSnackbarWorkaround;
import com.ichi2.lowanki.reviewer.ActionButtons;
...
import static com.ichi2.lowanki.cardviewer.ViewerCommand.COMMAND_NOTHING;
...
public class Reviewer extends AbstractFlashcardViewer {
    ...
    protected void updateScreenCounts() {
        ...
        if (actionBar != null) {
            if (mPrefShowETA) {
                ...
                actionBar.setSubtitle(Utils.remainingTime(LowkeyAnkiDroidApp.getInstance(), eta * 60));
            }
        }
    ...
    private void createWhiteboard() {
        SharedPreferences sharedPrefs = LowkeyAnkiDroidApp.getSharedPrefs(this);
    ...
    private void disableDrawerSwipeOnConflicts() {
        ...
        boolean gesturesEnabled = LowkeyAnkiDroidApp.initiateGestures(preferences);
        if (gesturesEnabled) {
