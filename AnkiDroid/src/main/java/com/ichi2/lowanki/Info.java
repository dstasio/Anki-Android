...
public class Info extends AnkiActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (mType == TYPE_NEW_VERSION) {
            LowkeyAnkiDroidApp.getSharedPrefs(Info.this.getBaseContext()).edit()
        ...
        if (canOpenMarketUri()) {
            ...
            marketButton.setOnClickListener(arg0 -> IntentUtil.tryOpenIntent(this, LowkeyAnkiDroidApp.getMarketIntent(this)));
        } else {
    ...
    private boolean canOpenMarketUri() {
        try {
            return IntentUtil.canOpenIntent(this, LowkeyAnkiDroidApp.getMarketIntent(this));
        } catch (Exception e) {
            Timber.w(e);
            return false;
        }
    ...
    private boolean isSendingCrashReports() {
        return LowkeyAnkiDroidApp.isAcraEnbled(this, false);
    }
}
