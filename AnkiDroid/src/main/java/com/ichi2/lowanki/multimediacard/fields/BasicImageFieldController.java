...
public class BasicImageFieldController extends FieldControllerBase implements IFieldController {
    ...
    private @Nullable String mAnkiCacheDirectory; // system provided 'External Cache Dir' with "temp-photos" on it
                                                  // e.g.  '/self/primary/Android/data/com.ichi2.lowanki.AnkiDroid/cache/temp-photos'
    ...
    public void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == ACTIVITY_SELECT_IMAGE) {
            try {
                ...
                LowkeyAnkiDroidApp.sendExceptionReport(e, "BasicImageFieldController - handleSelectImageIntent");
    ...
    private static Uri getUriForFile(File file, Context mActivity) {
        ...
        try {
            ...
            LowkeyAnkiDroidApp.sendExceptionReport(e, "BasicImageFieldController", "Unexpected getUriForFile failure on " + file, true);
        }
