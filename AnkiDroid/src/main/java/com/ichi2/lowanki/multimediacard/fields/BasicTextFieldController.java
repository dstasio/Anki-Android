...
import com.ichi2.lowanki.multimediacard.activity.PickStringDialogFragment;
...
public class BasicTextFieldController extends FieldControllerBase implements IFieldController,
    ...
    /*
     * (non-Javadoc)
     * @see com.ichi2.lowanki.IFieldController#onActivityResult(int, int, android.content.Intent) When activity started
