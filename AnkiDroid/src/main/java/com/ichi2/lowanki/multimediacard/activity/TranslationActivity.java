...
import com.ichi2.lowanki.multimediacard.glosbe.json.Meaning;
import com.ichi2.lowanki.multimediacard.glosbe.json.Phrase;
import com.ichi2.lowanki.multimediacard.glosbe.json.Response;
import com.ichi2.lowanki.multimediacard.glosbe.json.Tuc;
import com.ichi2.lowanki.multimediacard.language.LanguagesListerGlosbe;
import com.ichi2.lowanki.runtimetools.TaskOperations;
import com.ichi2.lowanki.web.HttpFetcher;
...
public class TranslationActivity extends FragmentActivity implements DialogInterface.OnClickListener, OnCancelListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final SharedPreferences preferences = LowkeyAnkiDroidApp.getSharedPrefs(getBaseContext());
