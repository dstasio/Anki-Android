...
package com.ichi2.lowanki.provider;
...
import com.ichi2.lowanki.BuildConfig;
...
import static com.ichi2.lowanki.FlashCardsContract.READ_WRITE_PERMISSION;
 ...
 * .../media (add media files to lowanki collection.media)
 * <p/>
...
//                break;
     ...
     *
     * For example: content://com.ichi2.lowanki.flashcards/notes?deckId=1234567890123
     *
    ...
    private void answerCard(Collection col, AbstractSched sched, Card cardToAnswer, @Consts.BUTTON_TYPE int ease, long timeTaken) {
        try {
            ...
            LowkeyAnkiDroidApp.sendExceptionReport(e, "doInBackgroundAnswerCard");
        }
    }
    ...
    private void buryOrSuspendCard(Collection col, AbstractSched sched, Card card, boolean bury) {
        try {
            ...
            LowkeyAnkiDroidApp.sendExceptionReport(e, "doInBackgroundBurySuspendCard");
        }
    }
