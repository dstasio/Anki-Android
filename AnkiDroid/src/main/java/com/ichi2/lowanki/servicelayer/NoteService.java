...
package com.ichi2.lowanki.servicelayer;
...
public class NoteService {
    ...
    /**
     * Saves the multimedia associated with this card to proper path inside lowanki folder. For each field associated with
     * the note it checks for the following condition a. The field content should have changed b. The field content does
     * not already point to a media inside lowanki media path If both condition satisfies then it copies the file inside
    ...
    private static void importMediaToDirectory(Collection col, IField field) {
        ...
        if (tmpMediaPath != null) {
            try {
                ...
                LowkeyAnkiDroidApp.sendExceptionReport(mediaException, "noteService::importMediaToDirectory");
            }
        }
    }
}
