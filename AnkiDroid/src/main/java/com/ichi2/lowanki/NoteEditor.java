...
//    public static final String TARGET_LANGUAGE = "TARGET_LANGUAGE";
    ...
    private void populateEditFields(FieldChangeType type, boolean editModelMode) {
        ...
        for (int i = 0; i < editLines.size(); i++) {
            ...
            if (LowkeyAnkiDroidApp.getSharedPrefs(this).getInt("note_editor_font_size", -1) > 0) {
                newTextbox.setTextSize(LowkeyAnkiDroidApp.getSharedPrefs(this).getInt("note_editor_font_size", -1));
            }
    ...
    private boolean onImagePaste(EditText editText, Uri uri) {
        try {
            ...
            //  org.chromium.chrome.browser.util.ChromeFileProvider from ProcessRecord{80125c 11262:com.ichi2.lowanki/u0a455}
    ...
    private ArrayList<CustomToolbarButton> getToolbarButtons() {
        Set<String> set = LowkeyAnkiDroidApp.getSharedPrefs(this).getStringSet("note_editor_custom_buttons", new HashSet<>());
