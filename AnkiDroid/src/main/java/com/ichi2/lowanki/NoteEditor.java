...
import com.ichi2.lowanki.dialogs.DiscardChangesDialog;
import com.ichi2.lowanki.dialogs.IntegerDialog;
import com.ichi2.lowanki.dialogs.LocaleSelectionDialog;
import com.ichi2.lowanki.dialogs.TagsDialog;
import com.ichi2.lowanki.exception.ConfirmModSchemaException;
import com.ichi2.lowanki.multimediacard.IMultimediaEditableNote;
import com.ichi2.lowanki.multimediacard.activity.MultimediaEditFieldActivity;
import com.ichi2.lowanki.multimediacard.fields.AudioClipField;
import com.ichi2.lowanki.multimediacard.fields.AudioRecordingField;
import com.ichi2.lowanki.multimediacard.fields.EFieldType;
import com.ichi2.lowanki.multimediacard.fields.IField;
import com.ichi2.lowanki.multimediacard.fields.ImageField;
import com.ichi2.lowanki.multimediacard.fields.TextField;
import com.ichi2.lowanki.multimediacard.impl.MultimediaEditableNote;
import com.ichi2.lowanki.noteeditor.FieldState;
import com.ichi2.lowanki.noteeditor.FieldState.FieldChangeType;
import com.ichi2.lowanki.noteeditor.CustomToolbarButton;
import com.ichi2.lowanki.noteeditor.Toolbar;
import com.ichi2.lowanki.receiver.SdCardReceiver;
import com.ichi2.lowanki.servicelayer.NoteService;
...
import com.ichi2.lowanki.widgets.PopupMenuWithIcons;
...
//    public static final String TARGET_LANGUAGE = "TARGET_LANGUAGE";
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        menu.findItem(R.id.action_capitalize).setChecked(LowkeyAnkiDroidApp.getSharedPrefs(this).getBoolean("note_editor_capitalize", true));
    ...
    protected static boolean shouldReplaceNewlines() {
        return LowkeyAnkiDroidApp.getSharedPrefs(LowkeyAnkiDroidApp.getInstance()).getBoolean("noteEditorNewlineReplace", true);
    }

    protected static boolean shouldHideToolbar() {
        return !LowkeyAnkiDroidApp.getSharedPrefs(LowkeyAnkiDroidApp.getInstance()).getBoolean("noteEditorShowToolbar", true);
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (itemId == android.R.id.home) {
            ...
            LowkeyAnkiDroidApp.getSharedPrefs(this).edit().putBoolean("noteEditorShowToolbar", item.isChecked()).apply();
            updateToolbar();
    ...
    private void toggleCapitalize(boolean value) {
        LowkeyAnkiDroidApp.getSharedPrefs(this).edit().putBoolean("note_editor_capitalize", value).apply();
        for (FieldEditText f : mEditFields) {
    ...
    private void setFontSize(Integer fontSizeSp) {
        ...
        LowkeyAnkiDroidApp.getSharedPrefs(this).edit().putInt("note_editor_font_size", fontSizeSp).apply();
        for (FieldEditText f : mEditFields) {
    ...
    private void populateEditFields(FieldChangeType type, boolean editModelMode) {
        ...
        for (int i = 0; i < editLines.size(); i++) {
            ...
            SharedPreferences prefs = LowkeyAnkiDroidApp.getSharedPrefs(this);
    ...
    private boolean onImagePaste(EditText editText, Uri uri) {
        try {
            ...
            LowkeyAnkiDroidApp.sendExceptionReport(e, "NoteEditor:onImagePaste");
    ...
    private ArrayList<CustomToolbarButton> getToolbarButtons() {
        Set<String> set = LowkeyAnkiDroidApp.getSharedPrefs(this).getStringSet("note_editor_custom_buttons", new HashSet<>(0));
        return CustomToolbarButton.fromStringSet(set);
    }

    private void saveToolbarButtons(ArrayList<CustomToolbarButton> buttons) {
        LowkeyAnkiDroidApp.getSharedPrefs(this).edit()
