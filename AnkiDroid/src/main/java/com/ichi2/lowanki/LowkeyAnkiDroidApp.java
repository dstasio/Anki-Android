...
import com.ichi2.lowanki.analytics.AnkiDroidCrashReportDialog;
import com.ichi2.lowanki.contextmenu.AnkiCardContextMenu;
import com.ichi2.lowanki.contextmenu.CardBrowserContextMenu;
import com.ichi2.lowanki.exception.ManuallyReportedException;
...
@AcraCore(
        ...
        logcatArguments = { "-t", "100", "-v", "time", "ActivityManager:I", "SQLiteLog:W", LowkeyAnkiDroidApp.TAG + ":D", "*:S" }
)
@AcraDialog(
...
public class LowkeyAnkiDroidApp extends Application {

    public static final String XML_CUSTOM_NAMESPACE = "http://arbitrary.app.namespace/com.ichi2.lowanki";
    ...
    private static LowkeyAnkiDroidApp sInstance;
    ...
    public static LowkeyAnkiDroidApp getInstance() {
        return sInstance;
    }
    ...
    public static void sendExceptionReport(Throwable e, String origin, @Nullable String additionalInfo, boolean onlyIfSilent) {
        ...
        if (onlyIfSilent) {
            String reportMode = getSharedPrefs(getInstance().getApplicationContext()).getString(LowkeyAnkiDroidApp.FEEDBACK_REPORT_KEY, FEEDBACK_REPORT_ASK);
    ...
    public static class ProductionCrashReportingTree extends Timber.Tree {
        ...
        protected void log(int priority, String tag, @NonNull String message, Throwable t) {
            ...
            switch (priority) {
                ...
                case Log.INFO:
                    Log.i(LowkeyAnkiDroidApp.TAG, message, t);
                    break;

                case Log.WARN:
                    Log.w(LowkeyAnkiDroidApp.TAG, getTag() + "/ " + message, t);
                    break;

                case Log.ERROR:
                case Log.ASSERT:
                    Log.e(LowkeyAnkiDroidApp.TAG, getTag() + "/ " + message, t);
                    break;
            }
        }
    }
