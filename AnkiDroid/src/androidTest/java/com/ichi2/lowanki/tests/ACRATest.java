package com.ichi2.lowanki.tests;
...
import static com.ichi2.lowanki.LowkeyAnkiDroidApp.FEEDBACK_REPORT_ALWAYS;
import static com.ichi2.lowanki.LowkeyAnkiDroidApp.FEEDBACK_REPORT_ASK;
...
public class ACRATest extends InstrumentedTest {
    ...
    private LowkeyAnkiDroidApp mApp = null;
    ...
    @UiThreadTest
    public void setUp() {
        mApp = (LowkeyAnkiDroidApp) getTestContext().getApplicationContext();
    ...
    private void verifyDebugACRAPreferences() {
        ...
        assertEquals("ACRA feedback was not turned off correctly",
                LowkeyAnkiDroidApp.FEEDBACK_REPORT_NEVER,
                getSharedPrefs()
                        .getString(LowkeyAnkiDroidApp.FEEDBACK_REPORT_KEY, "undefined"));
    }
    ...
    public void testProductionConfigurationUserDisabled() throws Exception {
        ...
        setReportConfig(LowkeyAnkiDroidApp.FEEDBACK_REPORT_NEVER);
    ...
    public void testCrashReportLimit() throws Exception {
        ...
        Timber.plant(new LowkeyAnkiDroidApp.ProductionCrashReportingTree());
        ...
        CrashReportData crashData = new CrashReportDataFactory(getTestContext(),
                LowkeyAnkiDroidApp.getInstance().getAcraCoreConfigBuilder().build()).createCrashData(new ReportBuilder().exception(crash));

        assertTrue(new LimitingReportAdministrator().shouldSendReport(
                getTestContext(),
                LowkeyAnkiDroidApp.getInstance().getAcraCoreConfigBuilder().build(),
                crashData)
        );
        ...
        LowkeyAnkiDroidApp.deleteACRALimiterData(getTestContext());
    ...
    private void setAcraReportingMode(String feedbackReportAlways) {
        LowkeyAnkiDroidApp.getInstance().setAcraReportingMode(feedbackReportAlways);
    }
    ...
    private void setReportConfig(String feedbackReportAsk) {
        getSharedPrefs().edit()
                .putString(LowkeyAnkiDroidApp.FEEDBACK_REPORT_KEY, feedbackReportAsk).commit();
    }


    private SharedPreferences getSharedPrefs() {
        return LowkeyAnkiDroidApp.getSharedPrefs(getTestContext());
    }
}
