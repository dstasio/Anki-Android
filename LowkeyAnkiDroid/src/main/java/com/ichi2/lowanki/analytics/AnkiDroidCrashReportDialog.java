...
public class AnkiDroidCrashReportDialog extends CrashReportDialog implements DialogInterface.OnClickListener, DialogInterface.OnDismissListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            CoreConfigurationBuilder builder = LowkeyAnkiDroidApp.getInstance().getAcraCoreConfigBuilder();
    ...
    public void onClick(DialogInterface dialog, int which) {
        if (which == DialogInterface.BUTTON_POSITIVE) {
            ...
            if (autoReport) {
                preferences.edit().putString(LowkeyAnkiDroidApp.FEEDBACK_REPORT_KEY, LowkeyAnkiDroidApp.FEEDBACK_REPORT_ALWAYS).apply();
                LowkeyAnkiDroidApp.getInstance().setAcraReportingMode(LowkeyAnkiDroidApp.FEEDBACK_REPORT_ALWAYS);
            }
