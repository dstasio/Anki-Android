...
import com.ichi2.lowanki.multimediacard.beolingus.parsing.BeolingusParser;
import com.ichi2.lowanki.multimediacard.language.LanguageListerBeolingus;
...
public class LoadPronounciationActivity extends Activity implements OnCancelListener {
    ...
    // Must be passed in
    public static final String EXTRA_SOURCE = "com.ichi2.lowanki.LoadPronounciationActivity.extra.source";
    // Passed out as a result
    public static final String EXTRA_PRONUNCIATION_FILE_PATH = "com.ichi2.lowanki.LoadPronounciationActivity.extra.pronun.file.path";
